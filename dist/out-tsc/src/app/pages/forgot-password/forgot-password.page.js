...
var ForgotPasswordPage = /** @class */ (function (_super) {
    ...
    function ForgotPasswordPage(view, authorizationService, route) {
    ...
    ForgotPasswordPage.prototype.send = function () {
        var _this = this;
        this.authorizationService.forgotPassword(this.dataForm.get("email").value).then(function (result) {
            _this.getError("forgotpassword.message");
